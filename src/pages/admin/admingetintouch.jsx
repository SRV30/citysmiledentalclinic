...
const AdminContact = () => {
  ...
  return (
    <div className="adminContactContainer bg-gray-400 rounded-lg shadow-xl p-8">
      <h2 className="font-bold text-3xl mb-6 text-white">
        <br />
      ...
      {limitedContacts.length > 0 && (
        <div className="mt-6">
          <h3 className="font-bold text-2xl mb-4 text-yellow-200">
            Latest Submissions
          </h3>
          <ul>
