...
const ForgotPassword = () => {
  ...
  useEffect(() => {
    ...
    gsap.from(".forgot-password-button", { opacity: 0, delay: 0.5, y: 20, duration: 1 });
      ...
      <div className="flex items-center justify-center min-h-screen p-4 bg-gray-100">
        <div className="max-w-md w-full bg-white shadow-lg rounded-lg p-10 forgot-password-form">
          ...
          <form onSubmit={forgotPasswordSubmit}>
            ...
            <button
              type="submit"
              className="forgot-password-button w-full py-2 px-4 bg-blue-600 text-white font-bold rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-300 ease-in-out"
            >
