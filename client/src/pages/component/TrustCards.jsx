    ...
    >
      {cards.map((card) => (
        ...
        >
          ...
          <div className="relative z-10 w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-blue-50 flex items-center justify-center mb-4 md:mb-6 transition-transform duration-500 group-hover:scale-110 group-hover:bg-blue-600">
